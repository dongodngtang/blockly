 ...
 * This is the sum of the width of the flyout (250) and the category menu (105).
 * @type {number}
 */
Blockly.Toolbox.prototype.width = 355;
...
Blockly.Toolbox.Category.prototype.setSelected = function(selected) {
  ...
  if(!selected) {
    this.label_.style.color = '#575E75';
  } else {
    // set selectedItem to icon color
    this.label_.style.color = this.bubble_.style.backgroundColor;
  }
