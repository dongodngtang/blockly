 ...
 * @private
 */
Blockly.ZoomControls.prototype.ZOOM_BACK_ = 'zoom-back.svg';
...
Blockly.ZoomControls.prototype.ZOOMICONWIDTH_ = 20;
 ...
 * @private
 */
Blockly.ZoomControls.prototype.MARGIN_BETWEEN_ = 1;
...
Blockly.ZoomControls.prototype.position = function() {
  ...
  // rotate for horizontal zoom_controls
  this.svgGroup_.setAttribute('transform',
      'translate(' + (Number(this.left_) - 100) + ',' + (Number(this.top_) + 70) + ') rotate(90)');
};
...
Blockly.ZoomControls.prototype.createZoomOutSvg_ = function() {
  ...
  */
  ...
  var zoomoutSvg = Blockly.utils.createSvgElement(
      'image',
      {
        'width': this.ZOOMICONWIDTH_,
        'height': this.ZOOMICONWIDTH_,
        'y': (this.WIDTH_ * 2) + (this.MARGIN_BETWEEN_ * 2) + 6,
        'x': '8',
        'transform': 'scale(1, -1)'
      },
      this.svgGroup_
...
Blockly.ZoomControls.prototype.createZoomBackSvg_ = function() {
  /* This markup will be generated and added to the "blocklyZoom" group:
    <image width="110" height="36" y="0" xlink:href="../media/zoom-back.svg">
    </image>
  */
  var ws = this.workspace_;
  ...
  zoomresetSvg.setAttributeNS('http://www.w3.org/1999/xlink', 'xlink:href',
      ws.options.pathToMedia + this.ZOOM_BACK_);
};
/**
  ...
  */
  ...
  var zoomresetSvg = Blockly.utils.createSvgElement(
      'image',
      {
        'width': this.ZOOMICONWIDTH_,
        'height': this.ZOOMICONWIDTH_,
        'y': (this.WIDTH_ * 1) + (this.MARGIN_BETWEEN_ * 1) + 8,
        'x': '8',
        'transform': 'scale(1, -1)'
      },
      this.svgGroup_
