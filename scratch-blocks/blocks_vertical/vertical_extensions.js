...
Blockly.ScratchBlocks.VerticalExtensions.registerAll = function () {
  var categoryNames = ['control', 'data', 'data_lists', 'sounds', 'motion', 'looks', 'event', 'sensing', 'pen', 'operators', 'more',
    'aistarter', 'aistarter_motion', 'aistarter_sensor', 'aistarter_other', 'arduino',
    'mobileplatform', 'mobileplatform_motion', 'mobileplatform_sensor', 'mobileplatform_other',
    'magician_setting', 'magician_motion', 'magician_status', 'magician_io',
    'magician_lite_setting', 'magician_lite_motion', 'magician_lite_status', 'magician_lite_io',
    'arduinokit_visual', 'arduinokit_speech', 'arduinokit_joystick', 'controller'
  ];
