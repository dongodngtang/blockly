...
CLOSURE_COMPILER_NPM = "google-closure-compiler.cmd" if platform.system() == "Windows" else "google-closure-compiler"
...
if __name__ == "__main__":
  try:
    ...
    assert stdout.rstrip() == read(os.path.join("build", "test_expect.js")).rstrip()
