...
const messages = defineMessages({
  ...
  EnlightenmentKit_getViewerLanguageblock: {
    defaultMessage: 'Language',
    id: 'gui.opcodeLabels.viewerLanguage'
  }
});
...
class OpcodeLabels {
  constructor () {
    ...
    this._opcodeMap = {
      ...
      // AI启蒙套件翻译
      EnlightenmentKit_getViewerLanguageblock: { category: 'sensing' }
    };
  ...
  _refreshOpcodeMap () {
    ...
    this._opcodeMap.EnlightenmentKit_getViewerLanguageblock.labelFn = () => this._translator(messages.EnlightenmentKit_getViewerLanguageblock);
  }
