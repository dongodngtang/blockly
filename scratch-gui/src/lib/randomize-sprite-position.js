const randomizeSpritePosition = spriteObject => {
  ...
  if (Object.prototype.hasOwnProperty.call(spriteObject, 'json')) {
    // Library sprite object
    spriteObject.json.scratchX = randomX;
    spriteObject.json.scratchY = randomY;
  } else if (Object.prototype.hasOwnProperty.call(spriteObject, 'x') &&
    Object.prototype.hasOwnProperty.call(spriteObject, 'y')) {
