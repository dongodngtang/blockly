...
const SHOW_UPDATE_ALERT = 'scratch-gui/alerts/SHOW_UPDATE_ALERT';
const CLOSE_UPDATE_ALERT = 'scratch-gui/alerts/CLOSE_UPDATE_ALERT';
...
const showUpdateAlert = function () {
  return {
    type: SHOW_UPDATE_ALERT
  };
};

const closeUpdateAlert = function () {
  return {
