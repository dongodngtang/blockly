...
class Stage extends React.Component {
  constructor (props) {
    ...
    this.stageWrapperRef = React.createRef();
    this.state = {
  ...
  componentDidMount () {
    ...
    this.stageWrapperWidth = this.stageWrapperRef.current.clientWidth;
  }
  ...
  positionDragCanvas (mouseX, mouseY) {
    ...
    const scale = (this.stageWrapperWidth - this.rect.width) / 2;
    this.dragCanvas.style.transform = `translate(${mouseX + scale}px, ${mouseY}px) scale(0.8)`;
  }
  onStartDrag (x, y) {
