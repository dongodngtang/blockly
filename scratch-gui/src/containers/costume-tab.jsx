...
import addLibraryBackdropIcon from '../components/asset-panel/icon--add-backdrop-lib1.svg';
  ...
  UNSAFE_componentWillReceiveProps (nextProps, prevState) {
    ...
    if (this.props.editingTarget === editingTarget) {
      ...
      if (oldTarget.costumeCount !== target.costumeCount) {
        return Object.assign({}, prevState, { selectedCostumeIndex: target.currentCostume });
      }
    } else {
