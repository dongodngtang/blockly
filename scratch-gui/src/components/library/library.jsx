...
class LibraryComponent extends React.Component {
  ...
  render () {
    const extensionStyle = this.props.id === 'spriteLibrary' ? null : { justifyContent: 'center' };
    let libraryItems = (<p><FormattedMessage id="gui.library.noExtension" /></p>);

    if (this.getFilteredData().length) {
      libraryItems = this.getFilteredData().map((dataItem, index) => (
        <LibraryItem
