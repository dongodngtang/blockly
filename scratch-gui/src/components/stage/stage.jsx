...
const StageComponent = React.forwardRef((props, ref) => {
  const {
    canvas,
    dragRef,
    isColorPicking,
    ...
    <div>
      <div
        ...
        style={{
          ...
          minWidth: stageDimensions.scale === 0.85 ? '445px' : stageDimensions.width,
          display: 'flex',
      ...
      >
        <Box
          ...
          style={{
            height: isFullScreen ? stageDimensions.height : 270,
            width: isFullScreen ? stageDimensions.width : 360
          }}
        >
          <DOMElementRenderer
            domElement={canvas}
