...
const builtinExtensions = {
  ...
  speech2textFORMagician: () => require('../extensions/scratch3_speech2text'),
  MagicianLiteFORController: () => require('../extensions/scratch3_magicianlite'),
  MagicianLiteAIExtensionFORControllerFORMagician: () => [
    // require('../extensions/scratch3_speech2text'),
    // require('../extensions/scratch3_ai'),
    // require('../extensions/scratch3_ocr'),
    // require('../extensions/scratch3_sr')
  ]
  ...
  loadExtensionURL(extensionURL) {
    if (builtinExtensions.hasOwnProperty(extensionURL)) {
      ...
      if (Array.isArray(extension)) {
        this._loadedExtensions.set(extensionURL, true);

        return Promise.all(extension.map(ets =>
          this._registerInternalExtension(new ets(this.runtime)).then(serviceName => {
            this._loadedExtensions.set(ets.EXTENSION_ID, serviceName);
          })));
      }
